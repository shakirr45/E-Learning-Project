...
//update
if(isset($_REQUEST['updatelessonSubmitBtn'])){
    ...
    if($conn->query($sql) == TRUE){
        $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-2">lesson Updated </div>';
    }else{
        $msg = '<div class="alert alert-success col-sm-6 ml-5 mt-2">lesson Unable to Updated </div>';
    }
    }
}
...
<div class="container-fluid">
    ...
    <div class="form-group">   
        ...
        <div class="text-center">
            <button type="submit" class="btn btn-danger" id="updatelessonSubmitBtn" name="updatelessonSubmitBtn">Update</button>
